...
export const compoundClasses = defineCompoundClasses<AppAtomicClassName>()({
  ...
  "item-created-time": "f7 i moon-gray",
  "item-text": "ma0 special-wrap dark-gray f4 pointer",
  ...
  "item-action-button":
    "flex items-center pa1 ba bw1 br3 b--moon-gray bg-transparent pointer",
